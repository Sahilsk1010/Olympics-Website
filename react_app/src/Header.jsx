  ...
  return (
    <>
        ...
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a href='https://olympics.com/en/' target='_blank' className="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
            <img src={logo} className='h-12 w-36'></img>
          </a>
          <nav className="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
            <a href='/' className="mr-5 hover:text-gray-900">Olympics</a>
            ...
            <a href='/signin' className="mr-5 hover:text-gray-900" >Signin</a>
